...
type GetJobsJobIdExecutions404Response struct {
}

func (response GetJobsJobIdExecutions404Response) VisitGetJobsJobIdExecutionsResponse(w http.ResponseWriter) error {
	w.WriteHeader(404)
	return nil
}
